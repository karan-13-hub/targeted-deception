...
class InfoSetData:
    ...
    def printInfoSetDataTable(infoSets: dict[str,InfoSetData]):
        ...
        if 'tabulate' in sys.modules:
            table = tabulate(rows, headers=headers,tablefmt="pretty",stralign="left")
            print(table)
...
def setInitialStrategiesToSpecificValues():
    ...
    # player 1
    infoSets['K'].actions['b'].strategy=1
    infoSets['K'].actions['p'].strategy=0

    infoSets['Q'].actions['b'].strategy=2/3
    infoSets['Q'].actions['p'].strategy=1/3

    infoSets['J'].actions['b'].strategy=1/4
    infoSets['J'].actions['p'].strategy=3/4

    infoSets['Kpb'].actions['b'].strategy=1
    infoSets['Kpb'].actions['p'].strategy=0

    infoSets['Qpb'].actions['b'].strategy=1/3
    infoSets['Qpb'].actions['p'].strategy=2/3
...
if __name__ == "__main__":
    ...
    numIterations=1000000 # best numIterations for closest convergence
    ...
    if 'matplotlib' in sys.modules:
        ...
        # Display the plot
        plt.savefig('total_gain_per_iteration.png')
